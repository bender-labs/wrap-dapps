              ...
              args:
                [{
                ...
                },
                  {
                    prim: 'Pair',
                    args:
                      [{ prim: 'Pair', args: [{ int: '13944' }, { int: '13945' }] },
                        [{ prim: 'Elt', args: [{ string: 'decimals' }, { bytes: '30' }] },
                          {
                            ...
                            args:
                              [{ string: 'eth_contract' },
                                {
                                  bytes:
                                    '307837626432393430386631316432626663323363333466313832373562626632336262373136626337'
                                }]
                          },
                          { prim: 'Elt', args: [{ string: 'eth_name' }, { bytes: '4d656562697473' }] },
                          { prim: 'Elt', args: [{ string: 'eth_symbol' }, { bytes: 'e29a87' }] },
                          { prim: 'Elt', args: [{ string: 'isBooleanAmount' }, { bytes: '74727565' }] },
                          {
                            prim: 'Elt',
                            args: [{ string: 'name' }, { bytes: '57726170706564204d656562697473' }]
                          },
                          { prim: 'Elt', args: [{ string: 'symbol' }, { bytes: '77e29a87' }] }]]
                  }]
            },
              { int: '13946' }]
        }
