              ...
              args:
                [{
                ...
                },
                  {
                    prim: 'Pair',
                    args:
                      [{ prim: 'Pair', args: [{ int: '13938' }, { int: '13939' }] },
                        [{ prim: 'Elt', args: [{ string: 'decimals' }, { bytes: '30' }] },
                          {
                            ...
                            args:
                              [{ string: 'eth_contract' },
                                {
                                  bytes:
                                    '307836306534643738363632386665613634373866373835613664376537303437373763383661376336'
                                }]
                          },
                          {
                            prim: 'Elt',
                            args: [{ string: 'eth_name' }, { bytes: '4d7574616e744170655961636874436c7562' }]
                          },
                          { prim: 'Elt', args: [{ string: 'eth_symbol' }, { bytes: '4d415943' }] },
                          { prim: 'Elt', args: [{ string: 'isBooleanAmount' }, { bytes: '74727565' }] },
                          {
                            prim: 'Elt',
                            args:
                              [{ string: 'name' },
                                { bytes: '57726170706564204d7574616e744170655961636874436c7562' }]
                          },
                          { prim: 'Elt', args: [{ string: 'symbol' }, { bytes: '774d415943' }] }]]
                  }]
            },
              { int: '13940' }]
        }
