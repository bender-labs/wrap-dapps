              ...
              args:
                [{
                ...
                },
                  {
                    prim: 'Pair',
                    args:
                      [{ prim: 'Pair', args: [{ int: '13935' }, { int: '13936' }] },
                        [{ prim: 'Elt', args: [{ string: 'decimals' }, { bytes: '30' }] },
                          {
                            ...
                            args:
                              [{ string: 'eth_contract' },
                                {
                                  bytes:
                                    '307862393332613730613537363733643839663461636666626538333065386564376637356662396530'
                                }]
                          },
                          { prim: 'Elt', args: [{ string: 'eth_name' }, { bytes: '537570657252617265' }] },
                          { prim: 'Elt', args: [{ string: 'eth_symbol' }, { bytes: '53555052' }] },
                          { prim: 'Elt', args: [{ string: 'isBooleanAmount' }, { bytes: '74727565' }] },
                          {
                            prim: 'Elt',
                            args: [{ string: 'name' }, { bytes: '5772617070656420537570657252617265' }]
                          },
                          { prim: 'Elt', args: [{ string: 'symbol' }, { bytes: '7753555052' }] }]]
                  }]
            },
              { int: '13937' }]
        }
