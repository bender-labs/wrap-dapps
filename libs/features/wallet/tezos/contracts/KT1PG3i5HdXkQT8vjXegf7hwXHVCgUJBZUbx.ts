              ...
              args:
                [{
                ...
                },
                  {
                    prim: 'Pair',
                    args:
                      [{ prim: 'Pair', args: [{ int: '13932' }, { int: '13933' }] },
                        [{ prim: 'Elt', args: [{ string: 'decimals' }, { bytes: '30' }] },
                          {
                            ...
                            args:
                              [{ string: 'eth_contract' },
                                {
                                  bytes:
                                    '307836323961363733613832343263326163346237623863356438373335666265616332316136323035'
                                }]
                          },
                          { prim: 'Elt', args: [{ string: 'eth_name' }, { bytes: '536f72617265' }] },
                          { prim: 'Elt', args: [{ string: 'eth_symbol' }, { bytes: '534f52' }] },
                          { prim: 'Elt', args: [{ string: 'isBooleanAmount' }, { bytes: '74727565' }] },
                          {
                            prim: 'Elt',
                            args: [{ string: 'name' }, { bytes: '5772617070656420536f72617265' }]
                          },
                          { prim: 'Elt', args: [{ string: 'symbol' }, { bytes: '77534f52' }] }]]
                  }]
            },
              { int: '13934' }]
        }
